...
public class PatternFloodFill extends JFrame {
    ...
    // 1б) Исправленный алгоритм заливки текстурой на основе вашего кода
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            new PatternFloodFill().setVisible(true);
        });
    }
}
